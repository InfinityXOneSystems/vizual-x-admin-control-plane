...
import { Agent, User, Theme, UIConfiguration, PageNode, Message } from './types';
...
const App: React.FC = () => {
  ...
  if (isAuthenticating) {
    return <div className="h-screen w-screen bg-black flex items-center justify-center text-[#2AF5FF] font-mono">INITIALIZING VIZUAL-X...</div>;
  }

  if (!isAuthenticated) {
    if (typeof LoginPage === 'undefined') return <div className="p-10 text-white">Login Module Loading...</div>;
